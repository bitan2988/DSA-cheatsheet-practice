Introsort begins with QUICK-SORT and if the recursion depth goes more than a particular limit it switches to Heap-Sort to avoid Quicksort’s worse case O(N2) time complexity. 
...
So first it creates a partition. Three cases arises from here.
	...
	If the partition size is too small then Quicksort decays to Insertion Sort. We define this cutoff as 16 (due to research). 
